...
conv1 = layers.Conv1D(128, 17, padding='same', activation=tf.nn.relu)(d)
conv2 = layers.Conv1D(128, 17, padding='same', activation=tf.nn.relu)(conv1)
maxpooling1d1_1 = layers.MaxPooling1D(pool_size=2, strides=2)(conv2)
conv3 = layers.Conv1D(384, 9, padding='same', activation=tf.nn.relu)(conv2)
conv4 = layers.Conv1D(384, 9, padding='same', activation=tf.nn.relu)(conv3)
...
conv9 = layers.Conv1D(64, 13, padding='same', activation=tf.nn.relu)(maxpooling1d3)
conv10 = layers.Conv1D(64, 13, padding='same',activation=tf.nn.relu)(conv9)
conv11 = layers.Conv1D(64, 3, padding='same', activation=tf.nn.relu)(conv10)
conv12 = layers.Conv1D(64, 3, padding='same', activation=tf.nn.relu)(conv11)
...
# path = './model/Full DNN/dimension_reduction3.h5'
